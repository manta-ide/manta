  ...
  return (
    <BasePropertyEditor title={property.title}>
      <Textarea
        ...
        className="border-zinc-700 bg-zinc-800 text-white outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 w-full rounded !text-xs px-2 py-1.5 min-h-16"
      />
    </BasePropertyEditor>
  );
}
